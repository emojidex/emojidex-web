...
var UserTab = function () {
  ...
  _createClass(UserTab, [{
    ...
    value: function setUserTab() {
      ...
      var user_tab_list = $('<ul class="nav nav-tabs mb-m mt-m" id="user_tab_list"></ul>');
    ...
    value: function setData(data, meta, kind) {
      ...
      return this.getPagination(meta, tab_pane, 'favorite');
    }
    ...
    value: function getPagination(meta, pane, kind) {
      ...
      var limit = 5; //this.palette.EC.limit;
      var cur_page = meta.total_count === 0 ? 0 : meta.page;
      var max_page = Math.ceil(meta.total_count / limit);
      ...
      if (kind === 'favorite') {
        var callback = function callback(response) {
          ...
          return _this6.setData(response, _this6.palette.EC.User.Favorites.meta, 'favorite');
        };
        ...
        prev_func = function prev_func() {
          return _this6.palette.EC.User.History.prev();
        };
        next_func = function next_func() {
          return _this6.palette.EC.User.History.next();
        };
      }
